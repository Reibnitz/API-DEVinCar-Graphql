...
namespace API_DEVinCar_Graphql.Graphql
{
    ...
    public class VeiculoQueries
    {
        ...
        public async Task<IEnumerable<Veiculo>> GetAvailable(EVeiculo? tipoVeiculo, [Service] IVeiculoQueriesService listagemService)
        {
        ...
        public async Task<IEnumerable<Veiculo>> GetSold(EVeiculo? tipoVeiculo, [Service] IVeiculoQueriesService listagemService)
        {
        ...
        public async Task<IEnumerable<Veiculo>> GetHighestPrices(EVeiculo? tipoVeiculo, [Service] IVeiculoQueriesService listagemService)
        {
        ...
        public async Task<IEnumerable<Veiculo>> GetLowestPrices(EVeiculo? tipoVeiculo, [Service] IVeiculoQueriesService listagemService)
        {
            IEnumerable<Veiculo> veiculos = await listagemService.GetAllAsync(tipoVeiculo);
